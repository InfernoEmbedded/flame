 ...
 */
#define USB_CFG_VENDOR_NAME     'm','a','k','e','h','a','c','k','v','o','i','d','.','c','o','m'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'M','H','V','L','i','b',' ','k','e','y','b','o','a','r','d'
 ...
 */
#define USB_CFG_SERIAL_NUMBER   'm','a','k','e','h','a','c','k','v','o','i','d','.','c','o','m',':','k','e','y','b','o','a','r','d','1'
