...
CPPFLAGS += -I"." -I"$(LIBDIR)" -I"$(LIBDIR)/flame" -Wall -Wextra -g2 -gstabs -Os -fshort-enums -ffunction-sections -fdata-sections -fmerge-constants -fno-caller-saves -fno-dse -funsigned-char -funsigned-bitfields -mmcu=$(MCU) -DF_CPU=$(HZ)UL
...
%.o: %.S | checkparams
	...
	avr-gcc -x assembler-with-cpp -DF_CPU=$(HZ) -I"." -I"./flame" -mmcu=$(MCU) $(DEPFLAGS) -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
