...
%.o: ../%.cpp
	...
	avr-g++ -I"A:\eclipse\mhvlib" -DMHVLIB_CORE=1 -Wall -g2 -gstabs -Os -fpack-struct -fshort-enums -ffunction-sections -fdata-sections -fmerge-constants -fno-caller-saves -fno-dse -funsigned-char -funsigned-bitfields -fno-exceptions -mmcu=${AVRTARGETMCU} -DF_CPU=${AVRTARGETFCPU}UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o"$@" "$<"
